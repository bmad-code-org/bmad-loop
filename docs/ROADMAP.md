...
`which("psmux") and which("pwsh")` plus a version gate excluding releases ≤ 3.3.7 — ≤ 3.3.6
teardown can force-kill a recycled PID, and the backend's verbs are written against fixes
released in 3.3.8; tmux-windows →
